...
$locale = is_string($_POST['fb_locale'] ?? null) ? fb_normalize_locale($_POST['fb_locale']) : null;
if ($locale === null) { http_response_code(400); exit(fb_message($settings, 'invalid_request')); }
